...
11/16/2015 - Modified by Makoto Fujimoto (www.Makoto.io)
...
class PHP_ICO {
	 ...
	 *
	 * @param string|bool $file Optional. Path to the source image file.
	 ...
	 */
	function add_image( $image, $sizes = array() ) {
		if ( ! $this->_has_requirements )
			return false;

		/*if ( false === ( $im = $this->_load_image_file( $image ) ) )
			return false;*/
